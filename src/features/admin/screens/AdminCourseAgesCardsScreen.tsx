          ...
          <AdminCard>
            <div className="flex flex-wrap items-end justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="text-xs text-slate-500">{loading ? "تحميل..." : ""}</div>
              </div>
            </div>
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-[90px_110px_110px_1fr_120px]">
              <input
                value={newCardAge}
                  ...
                  >
                    {!isEditing ? (
                      ...
                      <div className="space-y-3">
                        <div className="grid gap-3 md:grid-cols-[90px_110px_110px_1fr]">
                          <input
                            value={editCardAge}
